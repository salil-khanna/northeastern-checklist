...
const Home = () => {
    ...
    const allQuestions = [
        ...
        {value: 1, question: "Went on a date with a Wentworth student"},
        {value: 1, question: "Went on a date with a BU student"},
        {value: 1, question: "Went on a date with a Harvard student"},
        {value: 1, question: "Went on a date with a MIT student"},
        {value: 1, question: "Had a date at a Northeastern dining hall"},
        {value: 1, question: "Had a date inside Snell library"},
        {value: 1, question: "Had a date inside any other campus building besides Snell and dorms"},
